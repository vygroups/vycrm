    ...
    <div class="app-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="invoices.php" class="nav-item active"><i class="fa-solid fa-file-invoice"></i><span
                        class="nav-text">Invoices</span></a>
                <a href="products.php" class="nav-item"><i class="fa-solid fa-boxes-stacked"></i><span
